...
void Particle::Draw()
{
	...
	App->render->blit(draw_priority, texture, position_to_draw.x, position_to_draw.y, NULL, scale,NULL,NULL,current_spin);
}

float Particle::calculateRatio(float final, float inital) const
{
